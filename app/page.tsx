      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <a href="#" className="flex items-center gap-3">
            <img src="/sitinel-logo.png" alt="Sitinel" className="h-10 w-10 object-contain brightness-0 invert" />
    ...
    <section className="relative min-h-screen flex items-center justify-center bg-navy overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <div className="flex justify-center mb-8">
          <img src="/sitinel-logo.png" alt="Sitinel" className="h-24 w-24 object-contain brightness-0 invert opacity-90" />
        </div>
